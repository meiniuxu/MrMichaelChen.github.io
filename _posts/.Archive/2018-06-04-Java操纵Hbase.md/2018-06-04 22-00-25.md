...
public class HbaseDao {
	...
	public static void main(String[] args) throws IOException {
		...
		insertData("cdx","Cdx_Data","column1","familyname","keyvalue");
		insertData("cdx","Cdx_Data","column1","familyname1","keyvalue1");
		insertData("cdx","Cdx_Data","column1","familyname1","keyvalue");
		//insertData("sxc","cdx");
		ResultScanner rs = QueryAll("Cdx_Data");
		if(rs != null) {
			for (Result r : rs) {
				System.out.println("获得到rowkey:"+new String(r.getRow()));
				for (KeyValue keyValue : r.raw()) {
					// System.out.println(new String(keyValue.getFamily()));
					System.out.println("列"+new String(keyValue.getRow())+"   FamilyName:"+new String(keyValue.getQualifier())+"  值："+new String(keyValue.getValue()));
				}
			}
		}
...
public class import_data {
	public static void main(String[] args) throws IOException {
//		HbaseDao.createTable("hbasetest");
//		HbaseDao.QueryAll("hbasetest");
//		查看当前文件夹下的所有文件。
//		getFile("./");
//		read_data(".\\src\\hadoop_pro\\1.txt");
		HbaseDao.createTable("hbasetest");
		List resultlist = new ArrayList(); 
		resultlist = readFileByLines(".\\src\\hadoop_pro\\1.txt");
//		System.out.println(resultlist);
		for(int i=0;i<resultlist.toArray().length;i=i+2) {
			System.out.println(resultlist.toArray()[i]);
			System.out.println(resultlist.toArray()[i+1]);
			HbaseDao.insertData("cdxfirst", "hbasetest", "column1",	
					resultlist.toArray()[i].toString(), resultlist.toArray()[i+1].toString());
		}
		show_data("hbasetest");
